...
Usage:
    python extract_random_clip.py --source <source_directory> --output <output_directory> --count <number_of_movies>
...
Example:
    python extract_random_clip.py --source ~/foo/bar --output /Volumes/foo/bar --count 50
